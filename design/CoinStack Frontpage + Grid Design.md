...
<head>
  ...
  <style>
    ...
    /* Custom utilities (v3.1) */
    .category-bar { 
      position: absolute; left: 0; top: 0; bottom: 0; 
      width: 4px; border-radius: 8px 0 0 8px; /* Match card corners */
      z-index: 1;
    }
    .metal-badge {
...
### **Coin Cards (4-5 col responsive, v3.1)**

- **min-width: 360px, height: 170px** (horizontal layout).
- Image: 160×160px square with 3D flip animation.
- Category bar: 4px left edge with matching border-radius.
- Content: Ruler, year, legends (OBV/REV), reference, price.
- Badge row (right-aligned): [Cert] [Grade] [Metal] [Rarity●].
- Compact badges: 8px font, 2px 5px padding.
- Hover: subtle -2px lift with enhanced shadow.
